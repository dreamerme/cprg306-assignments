            ...
            <div>
                <nav className="p-5 flex flex-row">
                    ...
                    <button
                        ...
                        className={`text-white px-6 py-3 font-bold rounded-lg mx-2 transition duration-300 ease-in-out ${sortBy === "name" ? "bg-yellow-400" : "bg-blue-600"}`}
                    >
                        Name
                    </button>
                    <button
                        onClick={() => setSortBy("category")}
                        className={`text-white px-6 py-3 font-bold rounded-lg mx-2 transition duration-300 ease-in-out ${sortBy === "category" ? "bg-yellow-400" : "bg-blue-600"}`}
                    >
                        Category
                    </button>
                    <button
                        onClick={() => setSortBy("grouped")}
                        className={`text-white px-6 py-3 font-bold rounded-lg mx-2 transition duration-300 ease-in-out ${sortBy === "grouped" ? "bg-yellow-400" : "bg-blue-600"}`}
                    >
                        Group by Category
                    </button>
                </nav>
